  ...
  return (
    <>
      ...
      >
        ...
        <p className="font-bold p-3">Edit your comment</p>
        <textarea
          placeholder="Edit your comment"
          value={comment} // Bind to local state
          onChange={(e) => setComment(e.target.value)} // Update local state
...
EditCommentBox.propTypes = {
  comment: PropTypes.string.isRequired, // comment prop is required and should be a string
  setComment: PropTypes.func.isRequired, // setComment is a function to update the comment state
