...
import { createPosition, getAllPositions } from "../stores/positionStore";

const AddPositionBox = ({ closeDepartment }) => {
  ...
  const handleAddAppraisal = async () => {
    ...
    const newAddAppraisal = await dispatch(createPosition(title));
...
AddPositionBox.propTypes = {
  closeDepartment: PropTypes.func.isRequired,
};

export default AddPositionBox;
